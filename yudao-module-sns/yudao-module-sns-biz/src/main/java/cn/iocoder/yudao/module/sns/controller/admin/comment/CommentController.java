package cn.iocoder.yudao.module.sns.controller.admin.comment;
...
import cn.iocoder.yudao.module.sns.service.comment.CommentService;

@Tag(name = "管理后台 - 评论")
@RestController
@RequestMapping("/sns/comment")
@Validated
public class CommentController {
    ...
    @PreAuthorize("@ss.hasPermission('sns:comment:create')")
    ...
    @PreAuthorize("@ss.hasPermission('sns:comment:update')")
    ...
    @PreAuthorize("@ss.hasPermission('sns:comment:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('sns:comment:query')")
    ...
    @PreAuthorize("@ss.hasPermission('sns:comment:export')")
